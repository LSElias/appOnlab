...
export function ReporteDias () {
 ...
 const handleRequestSort = (event, property) => {
  ...
  const {control, handleSubmit, setValue, formState:{errors}}=
    ...
    const { responseData, errorData, loadedData } = useSubmitForm({ endpoint: `usuario/ReporteRegistro`, action, formData, start })
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={12}>
            <Typography component='h1' variant='h5' gutterBottom>
                Reporte Mayor Cantidad de Citas por Día de Registro
            </Typography>
          </Grid>
                      ...
                      .map((row, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell align='center'>{fechaFormateada(row.Fecha)}</TableCell>
